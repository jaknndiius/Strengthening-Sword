function gameStart() {
  ...
  SwordManager.appendSword(new Sword("그림자 검",0.75,8000,8000,3,true,new Piece("여신의 눈물",0.5),new Piece("망각의 구",0.5)));
  ...
  SwordManager.appendSword(new Sword("톱날 단검",0.7,12000,20000,3,true,new Piece("나보리 신속검",1, 2),new Piece("점화석",1, 2)));
  SwordManager.appendSword(new Sword("독사의 송곳니",0.65,15000,30000,5,true,new Piece("여신의 눈물",1),new Piece("충전형 물약", 0.5, 2),new Piece("마법의 영약", 0.5)));
  SwordManager.appendSword(new Sword("구인수의 격노검",0.65,20000,50000,5,true,new Piece("수은 장식띠",0.5)));
  SwordManager.appendSword(new Sword("폭풍갈퀴",0.6,25000,80000,5,true,new Piece("망각의 구",0.75),new Piece("수은 장식띠",0.5),new Piece("삼위일체",0.5)));
  SwordManager.appendSword(new Sword("핏빛 칼날",0.6,30000,100000,5,true,new Piece("삼위일체",0.75, 2),new Piece("바미의 불씨",1, 2)));
  SwordManager.appendSword(new Sword("헤르메스의 시미터",0.55,40000,130000,7,true,new Piece("미니언 해체 분석기",0.75),new Piece("수은 장식띠",1),new Piece("충전형 물약", 1)));
  SwordManager.appendSword(new Sword("수호천사",0.5,5000,50000,200000,7,true,new Piece("점화석",0.75)));
  SwordManager.appendSword(new Sword("마법사의 최후",0.45,70000,300000,7,true,new Piece("에테르 환영",0.75)));
  SwordManager.appendSword(new Sword("마나무네",0.4,100000,450000,7,true,new Piece("여신의 눈물",1),new Piece("마법의 영약", 1)));
  SwordManager.appendSword(new Sword("무라마나",0.4,150000,600000,7,true,new Piece("방출의 마법봉",1),new Piece("여신의 눈물",1)));
  SwordManager.appendSword(new Sword("피바라기",0.35,200000,1000000,10,true,new Piece("삼위일체",0.75),new Piece("역병의 보석",0.5)));
  SwordManager.appendSword(new Sword("월식",0.3,300000,1500000,10,true,new Piece("신록의 장막",0.75),new Piece("심연의 가면",0.5)));
  ...
  SwordManager.appendSword(new Sword("맬모셔스의 아귀",0.2,1300000,13000000,13,true,new Piece("원칙의 원형낫",0.9,2)));
  SwordManager.appendSword(new Sword("무한의 대검",0.1,1500000,16000000,13,true,new Piece("나보리 신속검",1,10),new Piece("요정의 부적",1,10),new Piece("점화석",1,10),new Piece("망가진 초시계",1,20)));
  SwordManager.appendSword(new Sword("몰락한 왕의 검",0.05,2000000,18000000,15,true,new Piece("나보리 신속검",1,20),new Piece("요정의 부적",1,20),new Piece("점화석",1,20),new Piece("망가진 초시계",1, 20)));
