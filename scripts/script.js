function gameStart() {
  ...
  SwordManager.appendSword(new Sword("처형인의 대검",0.8,4300,3000,3,true,new Piece("나보리 신속검",0.5),new Piece("요정의 부적",0.5),new Piece("망가진 초시계",0.5),new Piece("초시계",0.5)));
  SwordManager.appendSword(new Sword("수호자의 검",0.8,5800,5000,3,true,new Piece("방출의 마법봉",1),new Piece("요정의 부적",0.5),new Piece("점화석",1, 2)));
  SwordManager.appendSword(new Sword("그림자 검",0.75,8000,10000,3,true,new Piece("여신의 눈물",0.5),new Piece("망각의 구",0.5)));
  SwordManager.appendSword(new Sword("열정의 검",0.7,10500,15000,3,true,new Piece("나보리 신속검",1),new Piece("미니언 해체 분석기",0.5),new Piece("바미의 불씨",0.5)));
  SwordManager.appendSword(new Sword("톱날 단검",0.7,13500,25000,3,true,new Piece("나보리 신속검",1, 2),new Piece("점화석",1, 2)));
  SwordManager.appendSword(new Sword("독사의 송곳니",0.65,16500,37000,5,true,new Piece("여신의 눈물",1),new Piece("충전형 물약", 0.5, 2),new Piece("마법의 영약", 0.5)));
  ...
  SwordManager.appendSword(new Sword("헤르메스의 시미터",0.55,40000,220000,7,true,new Piece("미니언 해체 분석기",0.75),new Piece("수은 장식띠",1),new Piece("충전형 물약", 1)));
  SwordManager.appendSword(new Sword("수호천사",0.5,50000,320000,7,true,new Piece("점화석",0.75)));
  SwordManager.appendSword(new Sword("마법사의 최후",0.45,70000,460000,7,true,new Piece("에테르 환영",0.75)));
  SwordManager.appendSword(new Sword("마나무네",0.4,100000,650000,7,true,new Piece("여신의 눈물",1),new Piece("마법의 영약", 1)));
  SwordManager.appendSword(new Sword("무라마나",0.4,150000,915000,7,true,new Piece("방출의 마법봉",1),new Piece("여신의 눈물",1)));
  SwordManager.appendSword(new Sword("피바라기",0.35,250000,1230000,10,true,new Piece("삼위일체",0.75),new Piece("역병의 보석",0.5)));
  SwordManager.appendSword(new Sword("월식",0.3,370000,1880000,10,true,new Piece("신록의 장막",0.75),new Piece("심연의 가면",0.5)));
  SwordManager.appendSword(new Sword("드락사르의 황혼검",0.3,550000,3000000,10,true,new Piece("역병의 보석",1,3),new Piece("망각의 구",1, 2)));
  SwordManager.appendSword(new Sword("리치베인",0.25,780000,6000000,10,true,new Piece("심연의 가면",0.8,3)));
  SwordManager.appendSword(new Sword("요우무의 유령검",0.25,1050000,9000000,13,true,new Piece("요정의 부적",1,2)));
  SwordManager.appendSword(new Sword("맬모셔스의 아귀",0.2,1320000,11500000,13,true,new Piece("원칙의 원형낫",0.9,2)));
  SwordManager.appendSword(new Sword("무한의 대검",0.1,1620000,13700000,13,true,new Piece("나보리 신속검",1,10),new Piece("요정의 부적",1,10),new Piece("점화석",1,10),new Piece("망가진 초시계",1,20)));
